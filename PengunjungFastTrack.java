 ...
 * @author ASUS
 */
public class PengunjungFastTrack extends Pengunjung implements BehaviorPengunjung{
    public PengunjungFastTrack(String nama, int umur){
        super(nama, umur);
    }
    
    public void masukkeTamanHiburan(){
        System.out.println(getNama() + " dengan umur : " + getUmur() + " masuk ke taman hiburan(FastTrack)");
    }
